...
public class MovieRecorderView extends LinearLayout implements OnErrorListener {
	...
	public MovieRecorderView(Context context, AttributeSet attrs, int defStyle) {
		...
		mWidth = a.getInteger(R.styleable.MovieRecorderView_widths, 640);// 默认320
		mHeight = a.getInteger(R.styleable.MovieRecorderView_heights, 480);// 默认240
...
//		mMediaRecorder.setProfile(CamcorderProfile.get(CamcorderProfile.QUALITY_HIGH));
		mMediaRecorder.setVideoEncoder(VideoEncoder.H264);// 视频录制格式 可以防止视频传输倒置
