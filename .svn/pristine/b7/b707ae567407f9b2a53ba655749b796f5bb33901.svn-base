...
public class GaoJingTrainmanAdapter extends BaseAdapter {
    ...
    public GaoJingTrainmanAdapter(Activity context, List<TroublesModel> list, OnCallBackLook callBack) {
...
//        SpannableStringBuilder sp = new SpannableStringBuilder("历时: "+model.getLastTime());
//        sp.setSpan(new ForegroundColorSpan(Color.parseColor("#ff0000")), 4 ,4+model.getLastTime().length(), Spannable.SPAN_EXCLUSIVE_INCLUSIVE);
...
//        holder.last.setText(sp);
    ...
    private class Holder {
        ...
        TextView type, level,last;//类别  级别 历时
